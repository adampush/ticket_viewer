...
type CommandHelpers struct {
	ClaimTop      string `json:"claim_top"`      // tk start <id>
	ShowTop       string `json:"show_top"`       // tk show <id>
	ListReady     string `json:"list_ready"`     // tk ready
	ListBlocked   string `json:"list_blocked"`   // tk blocked
...
type TrackRecommendationGroup struct {
	...
	ClaimCommand    string           `json:"claim_command,omitempty"` // tk start <top_pick_id>
