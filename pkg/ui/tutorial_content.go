...
func structuredTutorialPages() []StructuredTutorialPage {
	return []StructuredTutorialPage{
		...
		// =============================================================
		{
			...
			Elements: []TutorialElement{
				Section{Title: "Welcome to Ticket Viewer"},
				...
				Spacer{Lines: 1},
				Paragraph{Text: "The solution: tkv brings issue tracking into your terminal, where you already work. No browser tabs. No context switching. No cloud dependencies."},
				Spacer{Lines: 1},
		...
		{
			ID:      "intro-philosophy",
			Title:   "Issue-First Philosophy",
			Section: "Introduction",
			Elements: []TutorialElement{
				Section{Title: "Why issue data in git?"},
				Paragraph{Text: "Think of git commits as discrete, meaningful steps in your project's history. Issues belong in that same timeline."},
				Spacer{Lines: 1},
				Section{Title: "Core Principles"},
				Spacer{Lines: 1},
				ValueProp{Icon: "①", Text: "Issues as First-Class Citizens - Your issue data gets the same git treatment as code: branching, merging, history."},
				Spacer{Lines: 1},
				...
				Spacer{Lines: 1},
				ValueProp{Icon: "④", Text: "Human and Agent Readable - The same data works for humans (tkv) and AI agents (--robot-* flags)."},
			},
		},
		{
			ID:      "intro-audience",
			...
			Elements: []TutorialElement{
				...
				Paragraph{Text: "Want lightweight issue tracking without subscription fees? Share your issue data through git. Everyone sees the same state."},
				Spacer{Lines: 1},
				Section{Title: "AI Coding Agents"},
				Paragraph{Text: "This is where tkv shines. AI agents need structured task management. The --robot-* flags output machine-readable JSON:"},
				Spacer{Lines: 1},
				Code{Text: "tkv --robot-triage   # What should I work on?\ntkv --robot-plan     # How can work be parallelized?"},
				Spacer{Lines: 1},
				Section{Title: "Anyone Tired of Context-Switching"},
				Paragraph{Text: "If you've ever lost your train of thought switching between your editor and a web-based tracker, tkv is for you."},
			},
		},
		{
			ID:      "intro-quickstart",
			...
			Section: "Introduction",
			Elements: []TutorialElement{
				Section{Title: "You're already running tkv!"},
				Spacer{Lines: 1},
		...
		// =============================================================
		{
			...
			Elements: []TutorialElement{
				Section{Title: "An issue is a unit of work"},
				Paragraph{Text: "Think of your project's work as linked items that together form the complete picture."},
				Spacer{Lines: 1},
				...
				Paragraph{Text: "Issues live in your project issue dataset in git:"},
				Bullet{Items: []string{
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Spacer{Lines: 1},
				Tip{Text: "Start your day with 'tk ready' to see actionable work"},
			},
		},
		{
			ID:      "concepts-labels",
		...
		// =============================================================
		{
			...
			Elements: []TutorialElement{
				...
				Code{Text: "TKV_SEARCH_MODE=hybrid\nTKV_SEARCH_PRESET=impact-first\nTKV_SEARCH_WEIGHTS='{\"text\":0.4,\"pagerank\":0.2,\"status\":0.15,\"impact\":0.1,\"priority\":0.1,\"recency\":0.05}'"},
				Spacer{Lines: 1},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Code{Text: "tkv --pages             # Interactive wizard\ntkv --export-pages ./out # Export to directory\ntkv --preview-pages ./out # Preview locally"},
				Spacer{Lines: 1},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Spacer{Lines: 1},
				Section{Title: "Setup"},
				Paragraph{Text: "Create a workspace config with repo paths and prefixes."},
				Spacer{Lines: 1},
				Section{Title: "Navigation"},
				KeyTable{Bindings: []KeyBinding{
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Paragraph{Text: "Stored in your recipe config and version controlled with your project."},
				Spacer{Lines: 1},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				KeyTable{Bindings: []KeyBinding{
					{Key: "tkv", Desc: "Interactive TUI for humans"},
					{Key: "--robot-*", Desc: "JSON output for agents"},
				}},
				Spacer{Lines: 1},
				Section{Title: "Key Robot Commands"},
				Code{Text: "tkv --robot-triage # The mega-command\ntkv --robot-next   # Single top priority\ntkv --robot-plan   # Parallel execution\ntkv --robot-alerts # Stale, inversions"},
				Spacer{Lines: 1},
				...
				Bullet{Items: []string{
					...
					"Complete: tk close ID -r \"Completed\"",
					"Repeat",
				}},
				Spacer{Lines: 1},
		...
		// =============================================================
		{
			...
			Elements: []TutorialElement{
				...
				Code{Text: "tk ready  # Show actionable issues"},
				Paragraph{Text: "Or in tkv: press r to filter to ready issues."},
				Spacer{Lines: 1},
				...
				Code{Text: "tk create \"Implement logic\" -t task -p 2\ntk dep ID-TESTS ID-ENDPOINT"},
				Spacer{Lines: 1},
				Section{Title: "Step 4: Complete & Sync"},
				Code{Text: "tk close ID -r \"Completed\"\n# then commit your code changes"},
				Spacer{Lines: 1},
				Tip{Text: "Check tk ready after each close - new work may have unblocked"},
			},
		},
		{
			...
			Elements: []TutorialElement{
				...
				Code{Text: "tk create \"Login fails with special chars\" -t bug -p 2"},
				Spacer{Lines: 1},
				...
				Code{Text: "tk dep ID-FEATURE ID-BUG  # Feature blocked by bug"},
				Spacer{Lines: 1},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Code{Text: "tkv --pages # Interactive wizard\n# Or direct:\ntkv --export-pages ./dashboard --pages-title \"Sprint 42\""},
				Spacer{Lines: 1},
				Section{Title: "Output Includes"},
				Bullet{Items: []string{
					"Triage recommendations",
