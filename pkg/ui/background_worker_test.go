...
func TestBackgroundWorker_NewWithoutPath_EnvDefaults(t *testing.T) {
	t.Setenv("TKV_DEBOUNCE_MS", "123")
	t.Setenv("TKV_CHANNEL_BUFFER", "3")
	t.Setenv("TKV_HEARTBEAT_INTERVAL_S", "9")
	t.Setenv("TKV_WATCHDOG_INTERVAL_S", "11")
